...
class IcnAsyncBundle(node: Node)(implicit p: Parameters) extends ZJBundle {
...
class DeviceIcnAsyncBundle(node: Node)(implicit p: Parameters) extends ZJBundle {
  val tx = new IcnRxAsyncBundle(node)
  val rx = new IcnTxAsyncBundle(node)
...
abstract class BaseIcnAsyncModule(node: Node)(implicit p: Parameters) extends ZJModule {
...
class IcnSideAsyncModule(node: Node)(implicit p: Parameters) extends BaseIcnAsyncModule(node) {
...
class DeviceSideAsyncModule(node: Node)(implicit p: Parameters) extends BaseIcnAsyncModule(node) {
  val io = IO(new Bundle {
